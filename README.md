...
-- Главное окно (Размер уменьшен до 200х75)
...
-- Иконка Свернутого режима (Появляется вместо главного окна)
local OpenButton = Instance.new("TextButton")
OpenButton.Size = UDim2.new(0, 25, 0, 25)
OpenButton.Position = UDim2.new(0.5, -12, 0.4, -12) -- По центру, но её можно перетащить
...
OpenButton.Draggable = true -- Иконку тоже можно двигать!
...
-- ========================================================
-- ЛОГИКА ИНТЕРФЕЙСА (Сворачивание и Анимации)
-- ========================================================
...
MinimizeButton.MouseButton1Click:Connect(function()
	-- Переносим иконку "С" туда же, где было окно, чтобы она не прыгала в центр экрана
...
OpenButton.MouseButton1Click:Connect(function()
	-- Возвращаем окно на место, где осталась иконка
...
SendButton.MouseButton1Click:Connect(function()
	...
	if text ~= "" then
		...
		TextBox.Text = "" -- Очищаем строку после отправки
	end
end)

-- Дополнительно: Отправка по нажатию Enter на клавиатуре
